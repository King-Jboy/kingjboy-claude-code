...
FCC_COMMANDS="fcc-desktop fcc-server fcc-claude fcc-codex fcc-pi fcc-hermes fcc-dsh fcc-grok fcc-doctor fcc-context fcc-extension fcc-bridge fcc-init free-claude-code"
